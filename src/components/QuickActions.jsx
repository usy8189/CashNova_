    ...
    return (
        <>
            <button
                ...
                className="quick-action-btn group flex flex-col items-center justify-center gap-2.5 rounded-xl border border-white/[0.06] bg-white/[0.02] py-8 transition-all hover:bg-indigo-500/10 hover:border-indigo-500/20"
            >
            ...
            <button
                ...
                className="quick-action-btn group flex flex-col items-center justify-center gap-2.5 rounded-xl border border-white/[0.06] bg-white/[0.02] py-8 transition-all hover:bg-purple-500/10 hover:border-purple-500/20"
            >
            ...
            <button
                ...
                className="quick-action-btn group flex flex-col items-center justify-center gap-2.5 rounded-xl border border-white/[0.06] bg-white/[0.02] py-8 transition-all hover:bg-emerald-500/10 hover:border-emerald-500/20"
            >
